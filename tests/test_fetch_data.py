...
def test_make_connection_returns_a_connection_object(mock_connection):
    mock_conn = Mock()
...
def test_get_data_fetch_data_for_staff_table():
    mock_columns = [
...
def test_make_connection_raises_exception():
    pass

def test_close_connection_raises_exception():
    pass

def test_get_data_run_raises_exception():
    pass